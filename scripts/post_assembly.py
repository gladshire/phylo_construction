...
def post_assembly(prot_ref, threads):
    ...
    for file_overrep in os.listdir(overrep_dir):
        ...
        if get_layout(curr_sra) == "SINGLE":
            ...
            file_transcript = file_overrep.split(".")[0][:-2:] + ".trinity.Trinity.fasta"
            ...
            cors_cmd = ["python3", "corset_wrapper.py", assembly_dir + file_transcript,
                        overrep_dir + file_overrep_1, overrep_dir + file_overrep_2, threads, out_dir + cors_dir]
